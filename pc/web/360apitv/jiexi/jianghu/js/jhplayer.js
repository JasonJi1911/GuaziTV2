							...
							if (this.type = t, this.options.video.customType && this.options.video.customType[t]) "[object Function]" ===
								...
								case "hls":
									if (Hls)
										...
										} else this.notice("正在加载中,如有问题联系客服！");
		...
		function(e, t, n) {
			...
			e.exports = function(e) {
				...
				return t +=
					...
					), t += '\n</div>\n<div class="yzmplayer-menu">\n    ', t += '<div class="yzmplayer-menu-item"> <a href="javascript:void(0);">视频统计信息</a> </div>', t +=
				...
				o = function() {
					...
					return a(e, [{
						...
						value: function() {
							...
							this.template.infoVersion.innerHTML = "8.8.8", this.template.infoType.innerHTML = this.player.type, this.template
